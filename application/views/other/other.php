	...
	<div class="container">
		...
		<section class="slider">
			<div class="slide slide--current" data-content="content-1">
				<div class="slide__mover">
					<div class="zoomer flex-center">
						<img class="zoomer__image" src="../public/img/other/images/iphone.png" alt="iPhone" />
						<div class="preview">
							<img src="../public/img/other/images/iphone-content-preview.png" alt="iPhone app preview" />
			...
			<div class="slide" data-content="content-2">
				<div class="slide__mover">
					<div class="zoomer flex-center">
						<img class="zoomer__image" src="../public/img/other/images/ipad.png" alt="iPad Mini" />
						<div class="preview">
							<img src="../public/img/other/images/ipad-content-preview.png" alt="iPad Mini app preview" />
			...
			<div class="slide" data-content="content-3">
				<div class="slide__mover">
					<div class="zoomer flex-center">
						<img class="zoomer__image" src="../public/img/other/images/macbook.png" alt="MacBook" />
						<div class="preview">
							<img src="../public/img/other/images/macbook-content-preview.jpg" alt="MacBook app preview" />
			...
			<div class="slide" data-content="content-4">
				<div class="slide__mover">
					<div class="zoomer flex-center">
						<img class="zoomer__image" src="../public/img/other/images/imac.png" alt="iMac" />
						<div class="preview">
							<img src="" />
			...
			<div class="slide" data-content="content-5">
				<div class="slide__mover">
					<div class="zoomer flex-center">
						<img class="zoomer__image" src="../public/img/other/images/apple-watch.png" alt="Apple Watch" />
						<div class="preview rounded">
							<img src="../public/img/other/images/apple-watch-content-preview.png" alt="Apple Watch app preview" />
		...
		<section class="content">
			<div class="content__item" id="content-1">
				<img class="content__item-img rounded-right" src="../public/img/other/images/iphone-content.png" alt="Apple Watch Content" />
			...
			<div class="content__item" id="content-2">
				<img class="content__item-img rounded-right" src="../public/img/other/images/ipad-content.jpg" alt="iPad Mini Content" />
				<div class="content__item-inner">
					<h2>The iPad Mini</h2>
					...
					<p><a href="#">Learn more about Performance &xrarr;</a></p>
				</div>
			</div>
			<div class="content__item" id="content-3">
				<img class="content__item-img rounded-right" src="../public/img/other/images/macbook-content.jpg" alt="MacBook Content" />
				<div class="content__item-inner">
					<h2>The MacBook</h2>
					...
					<p><a href="#">Learn more about the design &xrarr;</a></p>
				</div>
			</div>
			<div class="content__item" id="content-4">
				<img class="content__item-img rounded-right" src="../public/img/other/images/imac-content.jpg" alt="iMac Content" />
				<div class="content__item-inner">
					<h2>The iMac</h2>
					...
					<p><a href="#">Learn more about the iMac's features &xrarr;</a></p>
				</div>
			</div>
			<div class="content__item" id="content-5">
				<img class="content__item-img rounded-right" src="../public/img/other/images/apple-watch-content.png" alt="Apple Watch Content" />
				<div class="content__item-inner">
					...
					<p><a href="#">Learn more about new ways to connect &xrarr;</a></p>
				</div>
			</div>
